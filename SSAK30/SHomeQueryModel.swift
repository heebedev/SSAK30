...
protocol SHomeSellingQueryModelProtocol: class{
    ...
    func downloadItems(){
        ...
        let task = defaultSession.dataTask(with: url){(data, response, error) in
            if error != nil { // 에러코드가 없을 때 실행
                ...
                print("seller selling Data is downloaded")
...
// 판매완료된 떠리 상품 쿼리 
protocol SHomeDoneSellQueryModelProtocol: class{
    func itemDownloaded(items:NSArray)
}
    ...
    func downloadItems(){
        ...
        let task = defaultSession.dataTask(with: url){(data, response, error) in
            if error != nil { // 에러코드가 없을 때 실행
                ...
                print("seller done Sell Data is downloaded")
